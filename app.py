...
def inceregact():
   if request.method == 'POST':
      ...
      status = inc_reg(request.form['username'], request.form['password'],
...
def editact():
   if request.method == 'POST':
      ...
      status = editact1(request.form['username'], request.form['password'],
                        request.form['email'], request.form['mobile'])
...
def apact1():
   if request.method == 'POST':
      username = session['username']
      status = ap_act1(
          username, request.form['user'], request.form['post'], request.form['pic'], request.form['cmnt'])
